 ...
 * `sections.services` dictionary. Config-driven so each client lists their own
 * offering. Cards reveal with a stagger and lift toward an enquiry CTA.
 */
            ...
            <Reveal key={service.key} delay={0.05 * i}>
              ...
              >
                ...
                <h3 className="mt-4 font-display text-fluid-lg font-semibold text-navy">
                  {resolveText(dict, `sections.services.items.${service.key}.title`)}
                </h3>
